...
import { getUserData, userLogin } from '../Redux/Actions/LoginActions';
    ...
    let submitData = async (e) => {
        ...
        if (Object.keys(formErrors).length > 0) {
            ...
            if (check.data.length == 1) {
                if (check.data[0].password === registerData.password) {
                    dispatch(userLogin(check.data[0]))
                    window.location="/"
                }
                else {
                    console.log("else");
            ...
            <div className='signup-wrap'>
                <form method="post" onSubmit={(e) => submitData(e)}>
                    <div className="box" style={{ padding: "10px" }}>
                        ...
                        <button type="submit" className='register-btn' style={{ marginBottom: "15px" }}>Sign In</button>
